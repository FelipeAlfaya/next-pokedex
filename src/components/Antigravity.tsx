...
import { MousePositionProvider, useMousePositionRef } from "@/contexts/MousePositionContext";
...
function AntigravityInnerInner({
  count = 300,
  magnetRadius = 10,
  ringRadius = 10,
  waveSpeed = 0.4,
...
function AntigravityInner(props: AntigravityInnerProps) {
  return (
    <Canvas camera={{ position: [0, 0, 50], fov: 35 }}>
      <MousePositionProvider>
        <AntigravityInnerInner {...props} />
      </MousePositionProvider>
    </Canvas>
  );
}
